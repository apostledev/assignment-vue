...
export default defineComponent({
    ...
    setup(props){
        ...
        const loadIndexPage = async () => {
            indexPage.value = await jsonFetch(`${props.indexUrl}?page=${currentPage.value}`);
        }

        onMounted(loadIndexPage);
        watch(currentPage, loadIndexPage);
