...
export default defineComponent({
    ...
    setup(props){
        ...
        const loadIndexPage = async () => {
            indexPage.value = await jsonGet(`${props.indexUrl}?page=${currentPage.value}`);
        }
